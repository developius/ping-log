...
* .csv file produced by pinger.py (`r paste0(infile,".csv")`)
...
````{r, echo=FALSE}
dim(pingerDT)
### Table of responses to date -----
responses <- table(pingerDT$host, useNA = "always")

responses

print("Converting timestamp to r datetime")
